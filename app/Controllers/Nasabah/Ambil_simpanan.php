...
class Ambil_simpanan extends BaseController
{
    ...
    {
        $this->model = new Ambil_simpanan_model(); //Set Default Models Of this Controller
    ...
    protected function onLoad(){
        ...
        $this->PageData->parent = "Nasabah/Ambil_simpanan";
        $this->PageData->header = (!session()->has("hak_akses") ? NULL : ucfirst(str_replace("_", '', session("hak_akses"))) . " :: ") . 'Ambil Simpanan';
    ...
    public function index()
    {
        ...
        $this->PageData->title = "Nasabah/Ambil_simpanan";
        $this->PageData->subtitle = [
            $this->PageData->title => 'Nasabah/Ambil_simpanan/index'
        ];
        $this->PageData->url = "Nasabah/Ambil_simpanan/index";
        ...
        return view('Nasabah/ambil_simpanan/ambil_simpanan_list', $data);
        //endindex
    }
    ...
    {
        $id = $id==NULL?$this->request->getPostGet("id_ambilsimpanan"):base64_decode(urldecode($id));

        $this->PageData->header .= ' :: Detail';
        $this->PageData->title = "Ambil_simpanan Detail";
        $this->PageData->subtitle = [
            'Ambil_simpanan' => 'Nasabah/Ambil_simpanan/index',
            'Detail' => 'Nasabah/Ambil_simpanan/read/' . urlencode(base64_encode($id)),
        ];
        $this->PageData->url = "Nasabah/Ambil_simpanan/read/" . urlencode(base64_encode($id));
        ...
        return view('Nasabah/ambil_simpanan/ambil_simpanan_read', $data);
    }
    ...
    public function create()
    {
        ...
        $this->PageData->subtitle = [
            'Simpanan' => 'Nasabah/Saldo_nasabah/index',
            'Ambil Simpanan Nasabah' => 'Nasabah/Ambil_simpanan/create',
        ];
        $this->PageData->url = "Nasabah/Ambil_simpanan/create";

        $nasabah = new Kelola_nasabah_model();
        $ns = $nasabah->getById(session("id_nasabah"));
        $jenis = new Jenissimpan_pinjam_model();
        $j = $jenis->getById($ns->id_jenissimpanpinjam);
        $bunga = 0;
        if(isset($j->bunga_simpanan))$bunga = $j->bunga_simpanan;
        $saldo = $this->hitung_saldo_nasabah(session("id_nasabah"), $bunga);
        $data = [
            'data' => (object) [
        ...
        return view('Nasabah/ambil_simpanan/ambil_simpanan_form', $data);
    }
    ...
    public function createAction()
    {
        ...
        session()->setFlashdata('ci_flash_message', 'Pengajuan tersimpan, akan ditampilkan setelah diverifikasi oleh pimpinan.');
    ...
    public function update($id=NULL)
    {
        ...
        $this->PageData->title = "Update Ambil_simpanan";
        $this->PageData->subtitle = [
            'Ambil_simpanan' => 'Nasabah/Ambil_simpanan/index',
            'Update Item' => 'Nasabah/Ambil_simpanan/update/' . urlencode(base64_encode($id)),
        ];
        $this->PageData->url = "Nasabah/Ambil_simpanan/update/" . urlencode(base64_encode($id));
        ...
        $data = [
            'data' => (object) [
                'id_ambilsimpanan' => set_value('id_ambilsimpanan', $dataFind->id_ambilsimpanan),
    ...
    {
        $id = $this->request->getPostGet('oldid_ambilsimpanan');
        $dataFind = $this->model->getById($id);
    ...
    public function toExcel(){
        ...
        $this->response->setHeader('Content-Disposition', 'attachment;filename="Ambil_simpanan ' . date("Y") . '.xlsx"');
        // If you're serving to IE 9, then the following may be needed
        $cacheOptions = [
            'max-age'  => 1,
            's-maxage' => 900,
            'etag'     => 'excel_Ambil_simpanan'
        ];
    ...
    public function printAll(){
        ...
        $this->PageData->title = "Ambil_simpanan Data";
        $this->PageData->subtitle = ["Ambil_simpanan", "Print All"];
        $this->PageData->url = "Nasabah/Ambil_simpanan/printAll/";
        ...
        return view('Nasabah/ambil_simpanan/ambil_simpanan_print', $data);
    }
