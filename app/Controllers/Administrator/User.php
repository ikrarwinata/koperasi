...
class User extends BaseController
{
    ...
    public function index()
    {
        ...
        $this->PageData->title = "Akun Pengguna";
        $this->PageData->subtitle = [
            $this->PageData->title => 'Administrator/User/index'
        ];
        $this->PageData->url = "Administrator/User/index";
        ...
        return view('Administrator/user/user_list', $data);
        //endindex
    }
    ...
    {
        $id = $id==NULL?$this->request->getPostGet("id_user"):base64_decode(urldecode($id));

        $this->PageData->header .= ' :: Detail';
        $this->PageData->title = "User Detail";
        $this->PageData->subtitle = [
            'User' => 'Administrator/User/index',
            'Detail' => 'Administrator/User/read/' . urlencode(base64_encode($id)),
        ];
        $this->PageData->url = "Administrator/User/read/" . urlencode(base64_encode($id));
        ...
        return view('Administrator/user/user_read', $data);
    }
    ...
    public function create()
    {
        ...
        $this->PageData->title = "Create User";
        $this->PageData->subtitle = [
            'User' => 'Administrator/User/index',
            'Create New Item' => 'Administrator/User/create',
        ];
        $this->PageData->url = "Administrator/User/create";
        ...
        return view('Administrator/user/user_form', $data);
    }
    ...
    public function update($id=NULL)
    {
        ...
        $this->PageData->title = "Update User";
        $this->PageData->subtitle = [
            'User' => 'Administrator/User/index',
            'Update Item' => 'Administrator/User/update/' . urlencode(base64_encode($id)),
        ];
        $this->PageData->url = "Administrator/User/update/" . urlencode(base64_encode($id));
        ...
        $data = [
            'data' => (object) [
                'id_user' => set_value('id_user', $dataFind->id_user),
    ...
    {
        $id = $this->request->getPostGet('oldid_user');
        $dataFind = $this->model->getById($id);
    ...
    public function delete($id=NULL)
    {
        ...
        if ($row && $id != NULL) {
            ...
            $nasabah->where("username", $row->username)->delete();
