...
class Tambah_pinjaman_model extends Model
{
    ...
    protected $allowedFields = ['id_pinjaman', 'id_nasabah', 'id_jenissimpanpinjam', 'jumlah_pinjaman', 'lama_angsuran', 'total_angsuran', 'awal_pembayaran', 'akhir_pembayaran', 'jaminan', 'tgl_pencairan', 'keterangan'];
    ...
    public function export()
    {
        ...
        ->setCellValue('E'.$startRowHeader, 'Jumlah_pinjaman')
        ...
        foreach ($data_tambah_pinjaman as $key => $tambah_pinjaman) {
            ...
            if(isset($tambah_pinjaman->id_pinjaman))
                $spreadsheet->setActiveSheetIndex(0)->setCellValue('B'.$startRowBody, $tambah_pinjaman->id_pinjaman);
            if(isset($tambah_pinjaman->id_nasabah))
                $spreadsheet->setActiveSheetIndex(0)->setCellValue('C'.$startRowBody, $tambah_pinjaman->id_nasabah);
            if(isset($tambah_pinjaman->id_jenissimpanpinjam))
                $spreadsheet->setActiveSheetIndex(0)->setCellValue('D'.$startRowBody, $tambah_pinjaman->id_jenissimpanpinjam);
            if(isset($tambah_pinjaman->jumlah_pinjaman))
                $spreadsheet->setActiveSheetIndex(0)->setCellValue('E'.$startRowBody, $tambah_pinjaman->jumlah_pinjaman);
        ...
        for ($row = 1; $row <= $highestRow; $row++) {                  //  Read a row of data into an array                 
            ...
            if ($startImport == TRUE) {
                ...
                if (isset($cellData[0][$startColumnIndex + 3])){
                    $insertData["jumlah_pinjaman"] = $cellData[0][$startColumnIndex + 3];
                    $doInsert = TRUE;
                }else {
                    $doInsert = FALSE;
                }
                ...
                (
                    ...
                    strtolower($cellData[0][4]) == "jumlah_pinjaman" &&
