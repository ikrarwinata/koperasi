                                    ...
                                    <table class="table table-hover">
                                        <thead>
                                            <tr>
                                                ...
                                                <th style="transform: rotate(0);">
                                                    <a href="<?php echo (base_url($Page->parent . '/index?sortcolumn=' . base64_encode('id_tambahsimpanan') . '&sortorder=' . ($sortorder == 'ASC' ? 'DESC' : 'ASC'))); ?>" class="stringetched-link text-decoration-none" style="text-decoration: none;color: #243245;">
                                                        <?php if ($sortcolumn == "id_tambahsimpanan"): ?>
                                        ...
                                        <?php
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center"><?php echo ($value->id_tambahsimpanan) ?></td>
