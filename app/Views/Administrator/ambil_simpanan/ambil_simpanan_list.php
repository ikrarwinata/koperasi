...
<div class="col-12">
    <div class="row">
        <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12 mb-3">
            ...
            <a href="<?php echo base_url($Page->parent . '/create') ?>" class="btn btn-sm btn-primary">Ambil Simpanan Baru</a>&nbsp;
            <!--ENDIMPORTEXCELFILE-->
            <!--EXPORTBUTTONS-->
            <div class="dropdown">
                                                        ...
                                                        <div class="dropdown dropleft">
                                                            ...
                                                            <div class="dropdown-menu" aria-labelledby="<?php echo ('actionMenuButton' . $counter) ?>">
                                                                ...
                                                                <?php if (session("hak_akses") == "Pimpinan") : ?>
                                                                    <a class="dropdown-item" href="<?php echo base_url($Page->parent . '/update/' . urlencode(base64_encode($value->id_ambilsimpanan))) ?>" title="Terima pengajuan pinjaman">
                                                                        <i class="fa fa-handshake fa-lg"></i>&nbsp;
                                                                        Setujui
                                                                    </a>
                                                                <?php else : ?>
                                                                    <a class="dropdown-item" href="<?php echo base_url($Page->parent . '/update/' . urlencode(base64_encode($value->id_ambilsimpanan))) ?>" title="Validasi dan ajukan ke pimpinan">
                                                                        <i class="fa fa-check fa-lg"></i>&nbsp;
                                                                        Validasi
                                                                    </a>
                                                                <?php endif; ?>
                                                                <a class="dropdown-item" href="<?php echo base_url($Page->parent . '/delete/' . urlencode(base64_encode($value->id_ambilsimpanan))) ?>" onclick="javascript: return confirm('<?php echo ('Anda yakin ingin menolak pengajuan ini ?') ?>')" title="Tolak pengajuan ini">
