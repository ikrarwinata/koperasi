                ...
                <div class="card-body">
                    ...
                    <div class="form-row">
                        <div class="col-12 mb-3">
                            ...
                            <input type="password" class="form-control <?php echo (session()->getFlashdata('ci_flash_message_password_type')) ?>" autocomplete="on" name="password" id="password" maxlength="30" placeholder="Username" value="" />
                            <div class="invalid-feedback">
