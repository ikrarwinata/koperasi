...
<div class="col-12 col-lg-6 col-xl-6">
	...
	<div class="small-box bg-warning">
		<div class="inner">
			<h3>Rp. <?php echo (formatNumber(session("pinjaman"))) ?></h3>
		...
		<a href="<?php echo (base_url('Nasabah/Tambah_pinjaman/index')) ?>" class="small-box-footer">Bayar <i class="fas fa-arrow-circle-right"></i></a>
	</div>
</div>
<div class="col-12 col-lg-6 col-xl-6">
	<!-- small box -->
