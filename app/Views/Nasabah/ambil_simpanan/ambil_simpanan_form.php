            ...
            <div class="card">
                <div class="card-body">
                    <form action="<?php echo ($action) ?>" method="post">
                        ...
                        <div class="form-row">
                            <div class="col-12 mb-3">
                                <label for="nominal" data-toggle="tooltip" title="<?php echo ('Required') ?>">Nominal Diambil&nbsp;<code>*</code></label>
                                <input type="number" class="form-control <?php echo (session()->getFlashdata('ci_flash_message_nominal_type')) ?>" name="nominal" id="nominal" value="<?php echo ($data->nominal); ?>" min="1" max="<?php echo ($data->saldo) ?>" required placeholder="Masukan nilai yang akan anda ambil" />
