                    ...
                    <form action="<?php echo ($action) ?>" method="post">
                        ...
                        <div class="form-row">
                            <div class="col-12 mb-3">
                                ...
                                <textarea class="form-control <?php echo (session()->getFlashdata('ci_flash_message_keterangan_type')) ?>" rows="3" name="keterangan" id="keterangan" maxlength="50" placeholder="Keterangan" required ><?php echo ($data->keterangan); ?></textarea>
                                <div class="invalid-feedback">
